...
from ..live.control.lease import LiveOptions, ControlLease
...
def _owner() -> tuple[str, str]:
    ...
    if args.multi_user or context is None:
        raise ConnectorError(ErrorCode.UNAVAILABLE, "Live controls need a local, single-user ComfyUI browser.")
    running, _ = cast(
