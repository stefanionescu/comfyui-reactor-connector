...
var main_default = {
  reactorInc: {
    ...
    errors: {
      ...
      packageIdentityInvalid: "The package identity is invalid. Reinstall the package.",
      packageIdentityUnreadable: "The package identity could not be read. Reinstall it.",
    ...
    help: {
      label: "Help",
      close: "Close node help",
      guide: "Reactor node guide",
      liveControls: "Live controls",
      navigation: "Reactor guides",
      newTab: " (opens in a new tab)",
      project: "ComfyUI Reactor Connector",
      title: "Node help",
      workflows: "Workflows"
    },
    live: {
