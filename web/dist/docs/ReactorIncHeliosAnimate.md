...
1. Open [Helios image to video](/reactor-inc/v1/help/files/workflows/helios/helios-02-image-to-video.json).
...
3. Upload your picture in **Upload Your Starting Image**. You can use the
   [forest illustration](/reactor-inc/v1/help/files/workflows/assets/forest-illustration.png).
...
[troubleshooting guide](/reactor-inc/v1/help/ADVANCED.html#recovery).
