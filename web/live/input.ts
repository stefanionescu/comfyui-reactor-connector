...
export function cameraAxes(
   ...
   * @param negative - The key for the first direction.
   * @param positive - The key for the opposite direction.
   * @param first - The model's first direction value.
   * @param second - The model's opposite direction value.
   * @returns The chosen direction, or idle when neither or both keys are held.
   */
  function direction(negative: string, positive: string, first: string, second: string): string {
