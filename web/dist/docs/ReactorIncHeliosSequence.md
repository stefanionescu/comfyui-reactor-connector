...
Use the [live workflow](/reactor-inc/v1/help/files/workflows/helios/helios-05-live-prompt.json) when you want to
...
1. Open the [text sequence](/reactor-inc/v1/help/files/workflows/helios/helios-03-prompt-sequence.json) or
   [image sequence](/reactor-inc/v1/help/files/workflows/helios/helios-04-image-sequence.json) template.
...
generation fails, read the reported error and [troubleshooting guide](/reactor-inc/v1/help/ADVANCED.html#recovery)
