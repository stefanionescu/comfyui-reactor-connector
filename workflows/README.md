...
This folder contains 33 editable ComfyUI workflows, grouped by model. Each graph has connected nodes and setup instructions.

## Open a workflow

1. Open a JSON file listed below in ComfyUI. Built packages also include these examples in **Templates → reactor-inc**.
...
Select a Reactor node and choose **Help** for inputs, limits, and recovery steps. Use **Fit View** to find all nodes.
